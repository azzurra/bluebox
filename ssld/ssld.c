 ...
 *  USA
 *
 *  $Id: ssld.c 26465 2009-03-03 16:25:35Z androsyn $
 */
...
close_conn(conn_t * conn, int wait_plain, const char *fmt, ...)
{
	...
	rb_setselect(conn->plain_fd, RB_SELECT_READ, conn_plain_read_shutdown_cb, NULL);
...
main(int argc, char **argv)
{
	...
	if(s_ctlfd == NULL || s_pipe == NULL || s_pid == NULL)
	{
		...
		fprintf(stderr,
			"You get an Id tag for this: $Id: ssld.c 26465 2009-03-03 16:25:35Z androsyn $\n");
